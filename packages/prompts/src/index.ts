...
// Export built-in prompt templates
export const BUILTIN_PROMPTS = {
  CODE_REVIEW: `
<prompt id="code-review" version="1.0" provider="gemini" category="development">
  <variables>
  ...
  FEATURE_PLANNING: `
<prompt id="feature-planning" version="1.0" provider="gemini" category="planning">
  <variables>
  ...
  **Timeline:** {timeline}
  ...
  BUG_ANALYSIS: `
<prompt id="bug-analysis" version="1.0" provider="openrouter" category="debugging">
  <variables>
